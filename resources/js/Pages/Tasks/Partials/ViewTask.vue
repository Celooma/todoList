...
<template>
    <section>
        <header>
            <h2 class="text-lg font-medium text-gray-900">View Task Information</h2>
        </header>

        <div class="mt-5">
            <p class="text-md text-gray-600 mb-1"> <span class="text-lg text-black">Title</span> : {{ props.task.title }}</p>
